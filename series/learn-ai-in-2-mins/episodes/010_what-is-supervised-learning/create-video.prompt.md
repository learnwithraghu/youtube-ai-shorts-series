...
```
Create the YouTube Short video for Episode 010: "What is Supervised Learning?"
...
- Render remotion/out/010_what-is-supervised-learning.mp4 (1080x1920, ~90 seconds)
...
If render fails, diagnose and fix, then re-run npm run video:010.
...
Output: `remotion/out/010_what-is-supervised-learning.mp4`
